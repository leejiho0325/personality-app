...
const questions = [
  ...
  { category: "연애", type:"choice", text: "연애할 때 상대가 나를 좋아한다는 걸 어떻게 확인하나요?", context: "불안할 때 나오는 패턴.", choices: ["연락 빈도나 반응 속도로 판단한다", "직접 물어보거나 확인하려 한다", "상대의 행동 하나하나를 분석한다", "그냥 믿으려 한다. 확인하는 게 더 불안하다"] },
  { category: "연애", type:"choice", text: "사귀기 전, 좋아하는 사람 앞에서 당신은?", context: "자신도 모르게 나오는 행동.", choices: ["평소보다 더 잘 보이려고 신경을 많이 쓴다", "오히려 더 무덤덤하게 행동한다. 티 내기 싫어서", "자연스럽게 더 많이 챙기고 관심을 표현한다", "말이 없어지거나 어색해진다"] },
